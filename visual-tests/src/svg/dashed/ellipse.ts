...
function generate(){
  ...
  svg.appendChild(rc.circle(110 + 40, 110 + 40, 80, { fill: 'red', stroke: 'blue', hachureAngle: 0, strokeWidth: 3, fillLineDash: [15, 5], fillLineDashOffset: 10 }));
  svg.appendChild(rc.circle(210 + 40, 110 + 40, 80, { fill: 'pink', fillWeight: 3, hachureGap: 8, hachureAngle: 45, fillLineDash: [15, 5], fillLineDashOffset: 10 }));
